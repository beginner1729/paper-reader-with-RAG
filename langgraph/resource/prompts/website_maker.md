...
id: website_maker
inputs:
- description: Directory containing extracted TeX sources and all generated notes/diagrams.
  name: paper_dir
  type: path
- description: Markdown document explaining the paper (paper_flow.md).
  name: paper_flow_path
  type: path
- description: Directory containing Mermaid diagrams and PNGs.
  name: diagrams_dir
  type: path
maxSteps: 200
...
name: Website Maker
outputs:
- description: Directory containing the generated website files.
  name: website_dir
  type: path
- description: Main HTML index file of the website.
  name: website_index_path
  type: path
- description: JSON file containing glossary terms and definitions.
  name: glossary_path
  type: path
tools:
  apply_patch: true
