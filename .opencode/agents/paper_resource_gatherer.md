...
- archive_url: URL to arXiv abs/pdf/e-print or a .zip/.tar/.tar.gz/.tgz archive.
- paper_dir: Optional directory of extracted TeX sources (if already fetched).

Expected outputs (return paths in your response):
- paper_dir: Directory containing extracted TeX sources.
- outline_path: Markdown outline of the paper.
- bibliography_summary_path: Markdown summary of key referenced papers.
- resource_index_path: Markdown index of gathered resources.
